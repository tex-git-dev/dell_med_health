    ...
    <div class="modal-dialog"> 
      <div class="modal-content s3n2">
        ...
        <div class="modal-body">
          ...
          <p class="small"><f>Zygourakis CC, Valencia V, Moriates C. <a target="_blank"  href="http://jamanetwork.com/journals/jamasurgery/article-abstract/2589764">Association between surgeon scorecard use and operating room costs</a>. JAMA Surg 2016.</f></p>
        </div>
      </div>      
    </div>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content s3n3">
        ...
        <div class="modal-body">
          ...
          <p class="small"><f>Nabel EG, Braunwald E. <a target="_blank"  href="http://www.nejm.org/doi/full/10.1056/nejmra1112570#t=article">A tale of coronary artery disease and myocardial infarction</a>. N Enlg J Med 2012; 366:54-63.</f></p>
        </div>
      </div>      
    </div>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content s3n4">
        ...
        <div class="modal-body">
          ...
          <p class="small"><f>Anthes E. <a target="_blank"  href="http://www.nature.com/news/evidence-based-medicine-save-blood-save-lives-1.17224">Evidence-based medicine: save blood, save lives</a>. Nature 2015.</f></p>
        </div>
      </div>      
    </div>
  </div>
                  ...
                  <div class="col-sm-3 text-center">   
                   ...
                   <div class="col-sm-3 text-center">
                      <div class="panel-footer">                    
                        ...
                        <f><p>Improving outcomes for patients AND decreasing costs simultaneously <sup>1-3</sup></p></f>                      
                      </div>  
                  </div>
                </div>
                <hr>
         ...
         <div class="row">
           <div class="col-sm-2"></div>
            <div class="col-sm-8">
               ...
               <video id="myVideo" class="video-js vjs-default-skin  vjs-big-play-centered" width="640" height="264" controls poster="media/m1s3poster.png" data-setup='{"fluid": true}'>
               <source src="media/Module_1_Final.mp4" type="video/mp4"></source>
                 <source src="media/Module_1_Final.webm" type="video/webm"></source>
                 <source src="media/Module_1_Final.ogv" type="video/ogv"></source>
...
var listQuestion = function(J){  
    if(J<questions.length){
        ...
        var choicesOutput='<div class="row">';//new Array()
