...
<div class="m2s3p1">
    ...
    <br>
      ...
      <div class="Step1 container m2s3b2 ">
...
<div class="jumbotron m2s3b5 text-center">
     ...
     <div class="container m2s3b8">
        <hr>
        <f><h5 data-toggle="collapse" data-target="#demo" class="text-left" style="cursor:pointer;">REFERENCES <i  class="fa fa-angle-down" aria-hidden="true"></i></h5></f>
        <br>
      ...
      <div id="demo" class="collapse">
        <ol>
          ...
          <f><li><p>Teisberg E, Wallace S. “The Quality Tower of Babel.” <em>Health Affairs Blog</em>, April 13, 2015.</p></li></f>
        </ol>
      </div>        
   </div> 
...
<footer class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-4 text-left NextBtn">
              <a href="#" onclick="window.location='?id=m2/m2s2p1'"><i class="fa fa-angle-left fa-4x" aria-hidden="true"></i>
              <span class="ssp1">MODULE 2 | Section 2</span>
                <span class="sp1"><strong>Story From the Frontlines</strong></span></a>
            </div>
            <div class="col-sm-4"></div>
            <div class="col-sm-4  text-right NextBtn1">
                <a href="#" onclick="window.location='?id=m2/m2s4p1'"><span class="ssp2">MODULE 2 | Section 4</span>
