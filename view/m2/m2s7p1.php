...
<div class="container m2s7b6">
      ...
      <f><p>There are three key take-away points from this Care Redesign Case regarding approaches to introducing more value into a system t. First, to understand a problem, you need to measure the right things. Until wait list mortality became the focus of measurement and researchers found it was a more significant problem than worrying about post-transplant outcomes, the right questions were not asked and the outcomes that mattered to patients were not the focus. Second, establishing and measuring the right motivational outcome measure is critical. Using the patient specific, objective MELD measures rather than physician-driven or program-defined measures made the process of allocation more objective and more motivational than wait time, which was part of the old system. Third, transparency in reporting the effects of a change is important in engendering trust. Changing the way things are done in medicine can be difficult, but transparently reporting results from a change in practice and showing improvement goes a long way to increase the willingness to try a new approach.</p></f>
</div>
<br><br>
