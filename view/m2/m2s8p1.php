...
<div class="m2s8p1">
       <div class="jumbotron m2s8b1">
         ...
         <div class="row">
            <div class="col-sm-12"> 
             <f><p data--duration="1.5s"  >MODULE 2 | Section 8</p></f>
            </div>
           </div>
          <div class="row">
            <div class="col-sm-12"> 
              <f><h2>Conclusion: Measuring What Matters</h2></f>
            </div>
            </div>
          <div class="row">
            <div class="col-sm-12">  
      ...
      <div class="Step1 container bg-3">         
         <f><h3 class=" text-uppercase text-center">MODULE 2 SUMMARY</h3></f>         
         <br>
         <div class="row text-left">
            <div class="col-sm-12">
               <f><p>As we explored throughout this module, choosing meaningful outcomes to measure is critical. We need to set inspiring goals, and then work toward achieving those goals. Providing truly value-based health care relies on establishing and utilizing processes that systematically identify the needs and desires of our patients, and choosing the best treatment options to maximize outcomes.</p></f>
            </div>
            <div class="col-sm-12 ">
                <f><p>To systematically measure and improve patient-reported outcomes, we need to be strategic in the creation and dissemination of patient-reported outcome measures (PROMs). Crafted appropriately, PROMs can aid in identification of outcomes that matter most to patients, help patients and their physicians decide together whether and what kind of treatment would be most appropriate for them, and extend pre- and postoperative data collection on function and well-being. While PROMs and other outcome measures have challenges associated with them, trying to provide good medical care without measuring patient outcomes has even more fundamental challenges since things that are not measured are difficult to improve.</p></f> 
            </div>
            <div class="col-sm-12 ">
               <f><p>We explored the promising work being done to improve and grow the use of patient outcome measures and thus to accelerate improvement in health care value. While Module 1 identified and discussed the many gaps in our current ability to provide value in our health care, this module began to explore the ways in which those gaps can be filled through appropriate collection and utilization of data. As we continue this journey, we’ll dive into the costs of health care and examine how costs affect health care value and the patient experience.</p></f>
            </div>
          </div>
       </div>         
<br><br>
       <div class="container-full m2s8t2 bg-4">
        <div class="row s9col m2s8c2">
         <div class="col-sm-6">
              ...
              <div class="row m2s8c1">             
                <div class="col-sm-1"></div>
                  <div class="col-sm-11">
                      <f><h4>Story from the Frontlines: Failing Grades For Doing The Right Thing</h4></f>
                  </div>
              </div> 
              <div class="row m2s8c1">             
                <div class="col-sm-1"></div>
                  <div class="col-sm-11 bl small">
                      <f><p>Here is a story from a doctor plagued by measurement of volume and revenue, rather than value and the outcomes achived with patients.</p></f>
                  </div>
              </div>
               <div class="row m2s8c1"> 
               <br>            
