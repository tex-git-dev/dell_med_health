...
<link rel="stylesheet" href="css/survey.css">
 ...
 <p class="text-center" style="font-size:20px;padding:0px 150px;">You have completed the first collection of modules in Dell Medical School’s series on Value-Based
Health Care, <b>Introduction to Value-Based Health Care.</b></p>

 <p class="text-center" style="font-size:20px;padding:0px 150px;">
...
experience, information, and presentation valuable.</p>
 <h3 class="text-center">Please take a moment to</h3>
 <p class="text-center"><button style="padding:20px 100px;background:#43BEA7;color:white;">Complete our Survey</button></p>
<p class="text-center"  style="font-size:15px;font-weight:bold;">Your certificate will be emailed to you within a week of survey completion.</p>
<p class="text-center" style="font-size:15px;font-weight:bold;">Thank you!</p>
 </div>
