  ...
  <div class="container">
    <div class="row">            
        <div class="col-sm-12 text-center">          
          <f><p style="color:#96979b;">Figures adapted from the results of a TDABC Annualysis of Preoperative Assessment Process at an MD Anderson Preoperative Assessment Center.<sup>1</sup></p></f>
        </div>
    </div>
      <br><br>
    <div class="row">            
...
<p class="rbc calc2 text-uppercase" style="padding:25px 0;text-align:center;cursor:pointer;margin:5px;">Calculate</p>
</div>
...
$("#buttoncalc").removeClass("col-md-4");
...
var chkdisp1 = $(".m3s6p1 .spn1").css("display");
var chkdisp2 = $(".m3s6p1 .spn2").css("display");
var chkdisp3 = $(".m3s6p1 .spn3").css("display");
var chkdisp4 = $(".m3s6p1 .spn4").css("display");
var chkdisp5 = $(".m3s6p1 .spn5").css("display");
var chkdisp6 = $(".m3s6p1 .spn6").css("display");
var chkdisp7 = $(".m3s6p1 .spn7").css("display");
var chkdisp8 = $(".m3s6p1 .spn8").css("display");
var chkdisp9 = $(".m3s6p1 .spn9").css("display");
var chkdisp10 = $(".m3s6p1 .spn10").css("display");
var chkdisp11 = $(".m3s6p1 .spn11").css("display");
var chkdisp12 = $(".m3s6p1 .spn12").css("display");
var chkdisp13 = $(".m3s6p1 .spn13").css("display");
var chkdisp14 = $(".m3s6p1 .spn14").css("display");
var chkdisp15 = $(".m3s6p1 .spn15").css("display");
...
var chkdisp1 = $(".m3s6p1 .sspn1").css("display");
var chkdisp2 = $(".m3s6p1 .sspn2").css("display");
var chkdisp3 = $(".m3s6p1 .sspn3").css("display");
var chkdisp4 = $(".m3s6p1 .sspn4").css("display");
var chkdisp5 = $(".m3s6p1 .sspn5").css("display");
var chkdisp6 = $(".m3s6p1 .sspn6").css("display");
var chkdisp7 = $(".m3s6p1 .sspn7").css("display");
var chkdisp8 = $(".m3s6p1 .sspn8").css("display");
var chkdisp9 = $(".m3s6p1 .sspn9").css("display");
var chkdisp10 = $(".m3s6p1 .sspn10").css("display");
var chkdisp11 = $(".m3s6p1 .sspn11").css("display");
var chkdisp12 = $(".m3s6p1 .sspn12").css("display");
var chkdisp13 = $(".m3s6p1 .sspn13").css("display");
var chkdisp14 = $(".m3s6p1 .sspn14").css("display");
var chkdisp15 = $(".m3s6p1 .sspn15").css("display");
if(chkdisp1=="block" && chkdisp2=="block" && chkdisp3=="block" && chkdisp4=="block" && chkdisp5=="block" && chkdisp6=="block" && chkdisp7=="block" && chkdisp8=="block" && chkdisp9=="block" && chkdisp10=="block" && chkdisp11=="block" && chkdisp12=="block" && chkdisp13=="block" && chkdisp14=="block" && chkdisp15=="block")
{
ctr = 15;
}
...
$(".m3s6p1 .span1,.m3s6p1 .span2,.m3s6p1 .span3,.m3s6p1 .span4,.m3s6p1 .span5,.m3s6p1 .span6,.m3s6p1 .span7,.m3s6p1 .span8,.m3s6p1 .span9,.m3s6p1 .span10,.m3s6p1 .span11,.m3s6p1 .span12,.m3s6p1 .span13,.m3s6p1 .span14,.m3s6p1 .span15").css("display","block");
$(".m3s6p1 .vb1,.m3s6p1 .vb2,.m3s6p1 .vb3,.m3s6p1 .vb4,.m3s6p1 .vb5,.m3s6p1 .vb6,.m3s6p1 .vb7,.m3s6p1 .vb8,.m3s6p1 .vb9,.m3s6p1 .vb10,.m3s6p1 .vb11,.m3s6p1 .vb12,.m3s6p1 .vb13,.m3s6p1 .vb14,.m3s6p1 .vb15").css("visibility","visible");
ctr=15;
}
else
{
...
$(".m3s6p1 .span1,.m3s6p1 .span2,.m3s6p1 .span3,.m3s6p1 .span4,.m3s6p1 .span5,.m3s6p1 .span6,.m3s6p1 .span7,.m3s6p1 .span8,.m3s6p1 .span9,.m3s6p1 .span10,.m3s6p1 .span11,.m3s6p1 .span12,.m3s6p1 .span13,.m3s6p1 .span14,.m3s6p1 .span15").css("display","none");
$(".m3s6p1 .vb1,.m3s6p1 .vb2,.m3s6p1 .vb3,.m3s6p1 .vb4,.m3s6p1 .vb5,.m3s6p1 .vb6,.m3s6p1 .vb7,.m3s6p1 .vb8,.m3s6p1 .vb9,.m3s6p1 .vb10,.m3s6p1 .vb11,.m3s6p1 .vb12,.m3s6p1 .vb13,.m3s6p1 .vb14,.m3s6p1 .vb15").css("visibility","hidden");
