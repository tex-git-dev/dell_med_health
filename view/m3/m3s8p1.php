...
<div class="m3s8p1">
       <div class="jumbotron m3s7b1">
         <div class="container text-center bg-2">
         <br>
         <br>
         <div class="row">
            <div class="col-sm-12"> 
             <f><p data--duration="1.5s">MODULE 3 | Section 8</p></f>
            </div>
           </div>
          <div class="row">
            <div class="col-sm-12"> 
              <f><h2>Conclusion: Understanding Costs of Care</h2></f>
            </div>
            </div>
          <div class="row">
            <div class="col-sm-12">  
        ...
        <div class="row s9col m3s7c2">
         <div class="col-sm-6">
              ...
              <div class="row m3s7c1">             
                <div class="col-sm-1"></div>
                  <div class="col-sm-11">
                      <f><h4>Story from the Frontlines: All This for a Migraine</h4></f>
                  </div>
              </div> 
              <div class="row m3s7c1">             
                <div class="col-sm-1"></div>
              ...
              <div class="row  m3s7c3">             
                <div class="col-sm-1"></div>
                  <div class="col-sm-10 text-center"><f><h4>"This experience has not only tested my patience and caused me stress and anxiety about paying an outrageous bill for something that should have been covered, but has also given me perspective."</h4></f></div> 
                 <div class="col-sm-1"></div>  
              </div>
              <br>
              <div class="row m3s7c3">             
...
<br><br>
     ...
     <div class="container m3s7ms2 ">
             <f><h3 class="text-uppercase text-center">module 3 section summaries</h3></f>
          <br>
...
<br><br>
 ...
 <div class="jumbotron m3s7b6"> 
       <f><h2 class="text-center">Learn More</h2></f>
       <br>
          <div class="container m3s7b7">
