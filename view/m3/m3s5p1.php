...
<div class="m3s5p1">
  ...
  <div class="Step1 container m2s5b1">
     <div class="row">        
      ...
      <f><p>Recall key aspects of volume versus value-based health care as discussed in Module 1:</p></f>
      </div>
      <div class="col-sm-1"></div>     
    </div>
  </div>
...
<div class="container-full m3s5b3">
    <div class="container">
      ...
      <div class="col-sm-10"><f><h3 class="text-uppercase text-center boldT">Time-Driven Activity-Based Costing (TDABC)</h3></f>
        <br>
        <f><p>New methods for determining more accurate measurements of actual costs are increasingly being applied in health care. For example, Michael Porter and Robert Kaplan from Harvard Business School have advocated for the use of <em>time-driven activity-based costing</em> (TDABC).<sup>1</sup></p></f>
      </div>
      <div class="col-sm-1"></div>
      </div>
      <br>
   ...
   <div class="container m3s5b8">
    <div class="row">
      ...
      <div id="demo" class="collapse">
        <ol>
          <f><li><p>Kaplan RS, Anderson SR. Time-driven activity-based costing. <em>Harvard Business Review.</em> November, 2004.<br><a target="_blank" style="overflow-wrap: break-word; color:#f4821f;" href="https://hbr.org/2004/11/time-driven-activity-based-costing">https://hbr.org/2004/11/time-driven-activity-based-costing</a> Accessed March 27, 2017.</p></li></f>
          <f><li><p>Kaplan RS, Porter M. How to pay for health care. <em>Harvard Business Review.</em> July-August, 2016.<br><a target="_blank" style="overflow-wrap: break-word; color:#f4821f;" href="https://hbr.org/2016/07/how-to-pay-for-health-care">https://hbr.org/2016/07/how-to-pay-for-health-care</a> Accessed March 27, 2017.</p></li></f>
        </ol>        
      </div>  
      </div>      
      <div class="col-sm-1"></div> 
...
<footer class="container-fluid">
          <div class="row">
            <div class="col-sm-4 text-left NextBtn">
              <a href="#" onclick="window.location='?id=m3/m3s4p1'"><i class="fa fa-angle-left fa-4x" aria-hidden="true"></i>
            ...
            <div class="col-sm-4  text-right NextBtn1">
                <a href="#" onclick="window.location='?id=m3/m3s6p1'"><span class="ssp2">MODULE 3 | Section 6</span>
