...
?>
<link rel="stylesheet" href="css/m3s1p1.css">

<div class="m3s1p1">
       <div class="jumbotron m3s1b1">
         <div class="container text-center bg-2">
         <br>
         <br>
         <div class="row">
            <div class="col-sm-12"> 
             <f><p data--duration="1.5s">MODULE 3 | Section 1</p></f>
            </div>
         </div>
          <div class="row">
            <div class="col-sm-12"> 
              <f><h2>Understanding Costs In Health Care</h2></f>
            </div>
            </div>
          <div class="row">
            <div class="col-sm-12">  
...
<footer class="container-fluid">         
          <div class="row">
            ...
            <div class="col-sm-4  text-right NextBtn1">
                <a href="#" onclick="window.location='?id=m3/m3s2p1'"><span class="ssp2">MODULE 3 | Section 2</span>
