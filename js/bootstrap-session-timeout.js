...
;(function ($, document, window) {
    ...
    $.fn.userTimeout = function (opts) {
        ...
        var defaults = {
            ...
            modalBody: 'You\'re being timed out due to inactivity. Please choose to stay signed in or to logout. Otherwise, you will logged out automatically.'  // Modal Body
        };
        ...
        var modal = function () {
            ...
            if (modalUI === 'bootstrap') {
                ...
                logoutBtn = $('<button type="button" class="btn btn-default" id="logoff">Logout</button>');
