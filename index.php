 ...
 <div id="id01" class="w3-modal" style="z-index:99999;">
    <div class="w3-modal-content" style="background:url('https://s3.amazonaws.com/dell-med/img/bgLogin.png');color:white;">
      ...
      <span onclick="document.getElementById('id01').style.display='none'" class="w3-button w3-display-topright">&times;</span>
	   ...
	   <div class="col-md-12">
           <f>You have completed the Introduction to Value-Based Health Care modules. Please follow <a onclick="window.location='?id=survey'" class="mcmpnotnow" style="color:skyblue;cursor:pointer;">this link</a> to complete a survey about these modules. Once you have completed this survey, you will receive your certificate of completion for these modules. You must also complete this survey if you wish to receive CME credit as described <a href="./cme.html" target="_blank" style="color:skyblue;cursor:pointer;">here</a>.</f>
        </div>
